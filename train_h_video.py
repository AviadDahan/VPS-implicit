...
if __name__ == "__main__":
    ...
    parser.add_argument('-it', '--it', default=10, help='number of workers', required=False)
    ...
    parser.add_argument('-resx', '--resx', default=448, help='number of workers', required=False)
    parser.add_argument('-resy', '--resy', default=256, help='number of workers', required=False)
    ...
    parser.add_argument('-k', '--k', default=0.4, help='dataset task', required=False)
    ...
    parser.add_argument('--dataset', default='sun-hard', type=str, help="Path to pretrained weights to evaluate.")
